...
![Licence.lic KeyCreator](maj-keycreator-licences-flottantes/explorer_licence.png)
...
![Message erreur licence](maj-keycreator-licences-flottantes/msg-erreur-licence.png)
...
![Serveur de licence expiration](maj-keycreator-licences-flottantes/serveur_licence_expire.png)
...
- Aller dans “Manage current license activations”  
    ![License Wizard](maj-keycreator-licences-flottantes/lw_home.png)
- Puis **pour chaque licence** cliquer sur le bouton “Upgrade”  
    ![License Wizard - Manage licence](maj-keycreator-licences-flottantes/lw_manage_licence.png)
...
![Services Windows](maj-keycreator-licences-flottantes/services_windows.png)
...
- Puis cliquez sur “Other licensing options” puis “Restart the floating license service”
    ...
    ![License Wizard - Restart Server](maj-keycreator-licences-flottantes/lw_restart_server.png)
